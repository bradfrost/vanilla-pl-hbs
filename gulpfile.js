...
gulp.task("strip", function() {
	return gulp
		.src("./public/patterns/**/*.rendered.html")
		.pipe(gulpRemoveHtml())
...
gulp.task("copy:export-to-styleguide", function(done) {
	...
	gulp.src("public/css/**/*").pipe(
		gulp.dest("../style-guide/css")
	);

	// Export js directory to style guide js directory
	gulp.src("public/js/**/*").pipe(gulp.dest("../style-guide/js"));

	// Export icons to style guide root directory
	gulp.src("public/icons.svg").pipe(gulp.dest("../style-guide"));

	// Export images directory to style guide images directory
	gulp.src("public/images/**/*").pipe(
		gulp.dest("../style-guide/images")
	);
...
function getTemplateWatches() {
	return getSupportedTemplateExtensions().map(function(
		dotExtension
	) {
		return normalizePath(
...
gulp.task(
	"patternlab:watch",
	gulp.series("patternlab:build", "svg-sprite", watch)
);
gulp.task(
	"patternlab:serve",
	gulp.series(
